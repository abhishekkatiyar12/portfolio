...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_v1kxtr9", // Replace with your EmailJS Service ID
        "template_5lipqj6", // Replace with your EmailJS Template ID
        form.current,
        "vLRmu9beeHruddK2m" // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
